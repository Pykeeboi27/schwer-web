...
/**
 * Shared layout shell for all auth pages. Renders the full-bleed gradient
 * background with decorative blobs, the Schwer logo chip, and an optional
 * "Back to home" link above the page-specific form content.
 */
